...
public class KhachHangController {
    ...
    public ApiResponse<PageResponse<KhachHangResponse>> getAll(
            ...
            @RequestParam(required = false) Integer trangThai, // Bổ sung biến hứng trạng thái
        ...
        return new ApiResponse<>(
                ...
                service.getAll(keyword, trangThai, page, size, sortBy, direction) // Truyền xuống Service
        );
    }
    // Lấy theo ID
    @GetMapping("/{id}")
